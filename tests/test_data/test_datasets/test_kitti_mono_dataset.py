...
def test_getitem():
    ...
    kitti_dataset = KittiMonoDataset(
        ann_file='tests//data/cmpe249-fa22/kitti/kitti_infos_mono3d.coco.json',
        info_file='tests//data/cmpe249-fa22/kitti/kitti_infos_mono3d.pkl',
        pipeline=pipeline,
        data_root='tests//data/cmpe249-fa22/kitti/',
        img_prefix='tests//data/cmpe249-fa22/kitti/',
        test_mode=False)
    ...
    expected_filename = 'tests//data/cmpe249-fa22/kitti/training/image_2/000007.png'
...
def test_format_results():
    root_path = 'tests//data/cmpe249-fa22/kitti/'
    info_file = 'tests//data/cmpe249-fa22/kitti/kitti_infos_mono3d.pkl'
    ann_file = 'tests//data/cmpe249-fa22/kitti/kitti_infos_mono3d.coco.json'
    class_names = ['Pedestrian', 'Cyclist', 'Car']
    pipeline = [
    ...
    results = mmcv.load('tests//data/cmpe249-fa22/kitti/mono3d_sample_results.pkl')
    ...
    results = mmcv.load('tests//data/cmpe249-fa22/kitti/mono3d_sample_results2d.pkl')
    result_files, tmp_dir = kitti_dataset.format_results(results)
...
def test_evaluate():
    ...
    # format 3D detection results
    results = mmcv.load('tests//data/cmpe249-fa22/kitti/mono3d_sample_results.pkl')
    results2d = mmcv.load('tests//data/cmpe249-fa22/kitti/mono3d_sample_results2d.pkl')
