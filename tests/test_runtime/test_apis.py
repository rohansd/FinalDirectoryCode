...
def test_show_result_meshlab():
    ...
    tmp_dir.cleanup()
    # outdoor scene
    pcd = 'tests//data/cmpe249-fa22/kitti/training/velodyne_reduced/000000.bin'
    filename = 'tests//data/cmpe249-fa22/kitti/training/image_2/000000.png'
    box_3d = LiDARInstance3DBoxes(
        torch.tensor(
...
def test_inference_multi_modality_detector():
    ...
    # outdoor scene
    pcd = 'tests//data/cmpe249-fa22/kitti/training/velodyne_reduced/000000.bin'
    img = 'tests//data/cmpe249-fa22/kitti/training/image_2/000000.png'
    ann_file = 'tests//data/cmpe249-fa22/kitti/kitti_infos_train.pkl'
