...
```shell
python demo/pcd_demo.py demo//data/cmpe249-fa22/kitti/kitti_000008.bin configs/second/hv_second_secfpn_6x8_80e_kitti-3d-car.py checkpoints/hv_second_secfpn_6x8_80e_kitti-3d-car_20200620_230238-393f000c.pth
```
...
```shell
python demo/multi_modality_demo.py demo//data/cmpe249-fa22/kitti/kitti_000008.bin demo//data/cmpe249-fa22/kitti/kitti_000008.png demo//data/cmpe249-fa22/kitti/kitti_000008_infos.pkl configs/mvxnet/dv_mvx-fpn_second_secfpn_adamw_2x8_80e_kitti-3d-3class.py checkpoints/dv_mvx-fpn_second_secfpn_adamw_2x8_80e_kitti-3d-3class_20200621_003904-10140f2d.pth
```
